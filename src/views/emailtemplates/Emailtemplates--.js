                ...
                scopedSlots = {{
                  'action':
                      (item, index)=>{
                        return (
                          <CCardBody>
                            <CButton size="sm" color="info" className="ml-1" to={"/emailtemplates/edit/"+item.email_id}>Edit</CButton>
                            <CButton size="sm" color="danger" className="ml-1" to={"/emailtemplates/delete/"+item.email_id}>Delete</CButton>
                          </CCardBody>
                      )
                    }
                }}
